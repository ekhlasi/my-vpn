...
export const baseStyles = `
  ...
  [data-theme="dark"] {
    /* AMOLED palette (matches the Z-E-U-S scanner tool's look/feel):
       true-black background, deep-navy cards, a subtle blue border, and a
       blue-500 primary accent instead of the light theme's indigo/pink. */
    --primary: #3b82f6;
    --primary-dark: #2563eb;
